...
namespace KORMapper.Oracle
{
    /// <summary>
    /// Oracle用DBマッピングクラス
    /// <para>依存関係：Oracle接続用ライブラリs</para>
    /// </summary>
    public class OracleDbMapper : AbstractDbMapper,IDBMapperSelect,IDBMapperUpdate,IDBMapperInsert,IDBMapperTran
    {
